...
This package was created as part of a STAT 545B assignment. It is called ‘topcount’ and its goal is to allow you to simplify the process of searching for the top count of a given data set. 
